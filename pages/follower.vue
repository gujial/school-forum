<template>
  <v-container class="py-6">
    <h2 class="text-h5 font-weight-bold mb-4">我的粉丝</h2>
    ...
    <!-- 内容 -->
    <div v-else>
      <v-alert v-if="followers.length === 0" type="info" variant="tonal">
        暂无粉丝
      </v-alert>

      <v-list v-else lines="two" class="rounded-lg elevation-1">
        <FollowListItem v-for="f in followers" :key="f.follower_id" :user-id="f.follower_id" />
      </v-list>
